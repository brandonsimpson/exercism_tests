...
class WordProblemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPower()
    {
        ...
        $this->assertEquals(32, calculate('What is 2 raised to the 5th power?'));

    }

    public function testPower2()
    {

        $this->assertEquals(1.0000000000000001E+80, calculate('What is 10 raised to the 80th power?'));

    }

    public function testPower3()
    {

        $this->assertEquals(100000000, calculate('What is 10 to the power of 8?'));
